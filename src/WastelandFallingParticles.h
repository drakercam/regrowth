#ifndef WASTELANDFALLINGPARTICLES_H
#define WASTELANDFALLINGPARTICLES_H

#include "FallingParticles.h"

class WastelandFallingParticles : public FallingParticles {
public:
	WastelandFallingParticles(const Transform & t, const ofShader & shader, int numParticles, const ofImage & image)
